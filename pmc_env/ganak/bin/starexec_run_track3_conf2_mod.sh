...
./ganak/bin/doalarm ${tout_be} ./ganak/bin/arjun --backbone 1 $cleanfile --elimtofile $preprocessed_cnf_file | sed "s/^/c o /"
...
./ganak/bin/ganak -cs ${cache_size} $preprocessed_cnf_file | tee $solfile | sed "s/^/c o /"
